  ...
  function InnerSlider(props) {
    ...
    _defineProperty(
      ...
      function() {
        ...
        _this.list.addEventListener("mousemove", _this.swipeMove, {
          passive: false
        });
    ...
    _defineProperty(
      ...
      function() {
        _this.list.removeEventListener("mousemove", _this.swipeMove, {
          passive: false
        });

        _this.list.removeEventListener("touchmove", _this.swipeMove, {
          passive: false
        });
    ...
    _defineProperty(_assertThisInitialized(_this), "updateState", function(
      ...
      var targetLeft = (0, _innerSliderUtils.getTrackPositionProperties)(spec)
        .targetLeft;
    ...
    _defineProperty(_assertThisInitialized(_this), "swipeMove", function(e) {
      ...
      if (_this.state.dragging && touchMove) {
