...
exports.canUseDOM = exports.slidesOnLeft = exports.slidesOnRight = exports.siblingDirection = exports.getTotalSlides = exports.getPostClones = exports.getPreClones = exports.getTrackPositionProperties = exports.getTrackAnimateCSS = exports.getTrackCSS = exports.checkSpecKeys = exports.getSlideCount = exports.checkNavigable = exports.getNavigableIndexes = exports.swipeEnd = exports.swipeMove = exports.swipeStart = exports.keyHandler = exports.changeSlide = exports.slideHandler = exports.initializedState = exports.extractObject = exports.canGoNext = exports.getSwipeDirection = exports.getHeight = exports.getWidth = exports.lazySlidesOnRight = exports.lazySlidesOnLeft = exports.lazyEndIndex = exports.lazyStartIndex = exports.getRequiredLazySlides = exports.getOnDemandLazySlides = void 0;
...
var swipeMove = function swipeMove(e, spec) {
  ...
  var swipeLeft,
    state = {};
  var curLeft = getTrackPositionProperties(spec).targetLeft;
...
var swipeEnd = function swipeEnd(e, spec) {
  ...
  if (touchObject.swipeLength > minSwipe) {
    ...
    var currentLeft = getTrackPositionProperties(spec).targetLeft;
...
var getTrackPositionProperties = function getTrackPositionProperties(spec) {
  if (spec.unslick) {
    return 0;
  }
  ...
  var slideIndex = spec.slideIndex,
    ...
    noRightPadding = spec.noRightPadding,
  ...
  if (variableWidth === true) {
    ...
    if (noRightPadding) {
      var widthUntilListRightEnd = 0;

      for (
        var slide = targetSlideIndex;
    ...
    if (centerMode === true) {
      ...
      for (var _slide = 0; _slide < targetSlideIndex; _slide++) {
        targetLeft -=
          trackElem &&
          trackElem.children[_slide] &&
          trackElem.children[_slide].offsetWidth;
      }
  ...
  return {
    ...
    lastSlideIsInView: lastSlideIsInView
  };
};

exports.getTrackPositionProperties = getTrackPositionProperties;
